...
public class MonsterTwo {
    ...
    public void moveMonster(MonsterTwo[] monster, int arrayItemIndex)
    {
        ...
        while(isSpaceOpen)
        {
            int randMovementDirection = (int) (Math.random() * 4);
            int randMoveDistance = (int) (Math.random() * this.getMovement() + 1);

            System.out.println(randMoveDistance + " " + randMovementDirection);
            battleBoard[this.yPosition][this.xPosition] = '*';

            if(randMovementDirection == 0)
            {
            ...
            else if(randMovementDirection == 1)
            {
            ...
            else if(randMovementDirection == 2)
            {
